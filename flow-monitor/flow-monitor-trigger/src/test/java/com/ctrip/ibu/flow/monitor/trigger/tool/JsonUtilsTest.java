package com.ctrip.ibu.flow.monitor.trigger.tool;
...
public class JsonUtilsTest {
    ...
    public void testFindValue() {
        Object u = new User(1, "hahaha");
        String str = JsonUtils.toJson(u);
        System.out.println(JsonUtils.readTree(str).at("/name").asText());
    }
